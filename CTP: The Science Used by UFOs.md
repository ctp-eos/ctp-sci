...
CTP is the first and only framework that **ontologically explains** the [observed characteristics](https://fiveobservables.com) of [UAPs](https://duckduckgo.com/?q=uaps).
...
But they *do* exist. Therefore, something is wrong with present date physics *(more so - YOUR physics - not ours)*.
